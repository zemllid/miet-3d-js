...
export default function SheetPage() {
  ...
  const pageImages = sheet.totalPages 
    ? Array.from({ length: sheet.totalPages }, (_, i) => 
        `/sheets/${sheet.imageBase}.${i + 1}.jpg`
      )
    : [];
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <div className="flex gap-2">
          ...
          {sheet.totalPages && (
            <Badge variant="outline">{sheet.totalPages} страниц</Badge>
          )}
        </div>
      </div>
